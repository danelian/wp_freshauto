    ...
    <div class="contacts-section__container">
      <div class="contacts-section__left">
        <div class="heading">
          ...
          <p>Напишите нашего оператору, и мы будем рады дать консультацию!</p>
        </div>
        <div class="contacts__list">
          <div class="contacts-item">
            <div class="contacts-item__subtitle">для связи</div>
            <a href="tel:+18919891192">+1 891 989-11-92</a>
          </div>
          <div class="contacts-item">
            <div class="contacts-item__subtitle">Email</div>
            <a href="mailto:info@logoipsum.com">info@logoipsum.com</a>
          </div>
          <div class="contacts-item">
            <div class="contacts-item__subtitle">Адрес</div>
            <p>2972 Westheimer Rd. Santa Ana, Illinois 85486</p>
          </div>
          <div class="contacts-item">
            <div class="contacts-item__subtitle">соц. сети</div>
            <div class="socials">
      ...
      <div class="contacts-section__form">
        <h2>Написать нашему оператору</h2>
        <div class="form">
          ...
          <input type="submit" value="Связаться с нами" class="button-primary">
        </div>
      </div>
    </div>
  </div>
